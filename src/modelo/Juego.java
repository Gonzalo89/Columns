...
public class Juego {
	...
	private void piezaNueva() {
		...
		Bloque bloqueActual1 = new Bloque(randomPos, 0, randomNumColor1);
		Bloque bloqueActual2 = new Bloque(randomPos, 1, randomNumColor2);
		...
		this.piezaActual = new Pieza(bloqueActual1, bloqueActual2,
				bloqueActual3);
	...
	public void moverDerecha() {
		if (piezaActual != null) {
			if (Mapa.getInstance().estaLibre(
					piezaActual.getBloque3().getX() + 1,
